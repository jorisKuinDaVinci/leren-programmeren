...
if keuze_1 not in ['links', 'rechts']:
    while True: 
...
if keuze_1 == 'links':
    ...
    if keuze_2 not in ['aanbellen', 'weglopen']:
        while True:
    ...
    if keuze_2 == 'aanbellen':
        ...
        if keuze_2_5 not in ['a', 'weglopen']:
            while True: 
        ...
        if keuze_5 not in ['zwemmen', 'brug']:
            while True:
        ...
        if keuze_5 == 'brug':
            ...
            if keuze_6 not in ['oversteken', 'bos']:
                while True:
            ...
            if keuze_6 == 'oversteken':
                ...
                if keuze_7 not in ['oversteken', 'wachten']:
                    while True:
                ...
                if keuze_7 == 'wachten':
                    ...
                    if keuze_8 == 'huis':
                        ...
                        if keuze_9 not in ['links', 'rechts']:
                            while True:
                                    print("Dat is niet een keuze! kies links of rechts!")
                                    keuze_9 = input('je kunt kiezen om links of rechts te gaan wat doe je? (links of rechts)')
                        if keuze_9 == 'links':
                            ...
                            if keuze_10 == 'a':
                                ...
                                if keuze_11 not in ['aanbellen', 'weglopen']:
                                    while True:
                                            print("Dat is niet een keuze! kies aanbellen of weglopen!")
                                            keuze_11 = input('je kunt kiezen om aan te bellen of om weg te lopen wat doe je? (aanbellen of weglopen)')
