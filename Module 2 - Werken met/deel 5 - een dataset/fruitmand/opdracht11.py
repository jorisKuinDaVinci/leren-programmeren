...
if input_color not in set([fruit['color'] for fruit in fruitmand.fruitmand]):
...
round_count = len([fruit for fruit in fruitmand.fruitmand if fruit['color'] == input_color and fruit['round']])
