...
print(f"{str_amount_fraction(calc_amount_salt)} {str_units(calc_amount_salt, UNIT_TEASPOONS)} {TXT_SALT} ({weight_salt_g:.1f} g)")
print(f"{str_amount_fraction(calc_amount_pepper)} {str_units(calc_amount_pepper, UNIT_TEASPOONS)} {TXT_PEPPER} ({weight_pepper_g:.1f} g)")
...
print(f"{str_amount_fraction(calc_amount_spinach)} {str_units(calc_amount_spinach, UNIT_CUPS)} {TXT_SPINACH} ({weight_spinach_g:.1f} g)")
print(f"{str_amount_fraction(calc_amount_cheese)} {str_units(calc_amount_cheese, UNIT_CUPS)} {TXT_CHEESE} ({weight_cheese_g:.1f} g)")
print('-----------------------------------------------')